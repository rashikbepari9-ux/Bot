...
# ==========================================
TOKEN = "8830532965:AAFyKdegbOCXIG9PhDJfU2zRx1j70_ZPAJM"
...
firebase_credentials_json = r"""
{
  ...
  "project_id": "botkingz-b4881",
  "private_key_id": "d53b7cc9a70fa3a626b7af268e49f01ecec8a733",
  "private_key": "-----BEGIN PRIVATE KEY-----\\n-----END PRIVATE KEY-----\n",
  "client_email": "firebase-adminsdk-fbsvc@botkingz-b4881.iam.gserviceaccount.com",
  "client_id": "105995900668256554046",
  "auth_uri": "https://accounts.google.com/o/oauth2/auth",
  "token_uri": "https://oauth2.googleapis.com/token",
  "auth_provider_x509_cert_url": "https://www.googleapis.com/robot/v1/metadata/x509/firebase-adminsdk-fbsvc%40botkingz-b4881.iam.gserviceaccount.com",
...
def mask_number(num):
    clean = num.replace("+", "").replace(" ", "")
    if len(clean) > 6: return f"{clean[:3]}❖𝗛𝗘𝗫𝗔❖{clean[-3:]}"
    elif len(clean) > 2: return f"{clean[:1]}❖𝗛𝗘𝗫𝗔❖{clean[-1:]}"
    return clean
                ...
                if p.get("status") == "ON":
                    ...
                    for item in parsed_data:
                        ...
                        if unique_id not in processed_otps:
                            ...
                            display_msg = render_body_text(f"""<blockquote>┏━━━━━━━━━━━━━┓
┃ {prem_app_html}    𝗛𝗘𝗫𝗔 𝗡𝗨𝗠𝗕𝗘𝗥    {prem_app_html} 
┗━━━━━━━━━━━━━┛</blockquote>
<blockquote>{get_flag_info_html(display_num)} {masked} {lang}</blockquote>""")
...
def system_settings_keyboard():
    return {"inline_keyboard": [
        ...
        [{"text": "HEXA Control", "icon_custom_emoji_id": "5193100774988617665", "callback_data": "dxa_control", "style": "primary"},
